...
class TestDeviceControlPolicy:
    ...
    def test_queryDeviceControlPolicies(self):
        ...
        """
        assert (
            falcon.queryDeviceControlPolicies(parameters={"limit": 1})[
                "status_code"
            ]
            in AllowedResponses
        )
    ...
    def test_getDeviceControlPolicies(self):
        ...
        if policy["status_code"] != 500 and policy["body"]["resources"]:
            assert (
                falcon.getDeviceControlPolicies(
    ...
    def test_queryCombinedDeviceControlPolicies(self):
        ...
        """
        assert (
            falcon.queryCombinedDeviceControlPolicies(parameters={"limit": 1})[
                "status_code"
            ]
            in AllowedResponses
        )
